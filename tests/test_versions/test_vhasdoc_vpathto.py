...
def test_root_ref():
    ...
    assert versions.vpathto('a') == 'contents.html'
    ...
    pairs = list(versions)
    assert pairs == [('a', 'contents.html'), ('b', 'b/contents.html'), ('c', 'c_/contents.html')]

    # From 1 page.
    versions.context['pagename'] = '1'
    assert versions.vhasdoc('a') is True
    assert versions.vpathto('a') == '1.html'
    assert versions.vhasdoc('b') is True
    assert versions.vpathto('b') == 'b/1.html'
    assert versions.vhasdoc('c') is False
    assert versions.vpathto('c') == 'c_/contents.html'
    pairs = list(versions)
    assert pairs == [('a', '1.html'), ('b', 'b/1.html'), ('c', 'c_/contents.html')]

    # From sub/2 page.
    versions.context['pagename'] = 'sub/2'
    assert versions.vhasdoc('a') is True
    assert versions.vpathto('a') == '2.html'
    assert versions.vhasdoc('b') is True
    assert versions.vpathto('b') == '../b/sub/2.html'
    assert versions.vhasdoc('c') is False
    assert versions.vpathto('c') == '../c_/contents.html'
    pairs = list(versions)
    assert pairs == [('a', '2.html'), ('b', '../b/sub/2.html'), ('c', '../c_/contents.html')]

    # From sub/sub/3 page.
    versions.context['pagename'] = 'sub/sub/3'
    assert versions.vhasdoc('a') is True
    assert versions.vpathto('a') == '3.html'
    assert versions.vhasdoc('b') is True
    assert versions.vpathto('b') == '../../b/sub/sub/3.html'
    assert versions.vhasdoc('c') is False
    assert versions.vpathto('c') == '../../c_/contents.html'
    pairs = list(versions)
    assert pairs == [('a', '3.html'), ('b', '../../b/sub/sub/3.html'), ('c', '../../c_/contents.html')]

    # From sub/sub/sub/4 page.
    versions.context['pagename'] = 'sub/sub/sub/4'
    assert versions.vhasdoc('a') is True
    assert versions.vpathto('a') == '4.html'
    assert versions.vhasdoc('b') is True
    assert versions.vpathto('b') == '../../../b/sub/sub/sub/4.html'
    assert versions.vhasdoc('c') is False
    assert versions.vpathto('c') == '../../../c_/contents.html'
    pairs = list(versions)
    assert pairs == [('a', '4.html'), ('b', '../../../b/sub/sub/sub/4.html'), ('c', '../../../c_/contents.html')]
...
def test_b():
    ...
    assert versions.vpathto('c') == '../c_/contents.html'
    pairs = list(versions)
    assert pairs == [('a', '../contents.html'), ('b', 'contents.html'), ('c', '../c_/contents.html')]
    ...
    assert versions.vpathto('c') == '../c_/contents.html'
    pairs = list(versions)
    assert pairs == [('a', '../1.html'), ('b', '1.html'), ('c', '../c_/contents.html')]

    versions.context['pagename'] = 'sub/2'
    assert versions.vhasdoc('a') is True
    assert versions.vpathto('a') == '../../sub/2.html'
    assert versions.vhasdoc('b') is True
    assert versions.vpathto('b') == '2.html'
    assert versions.vhasdoc('c') is False
    assert versions.vpathto('c') == '../../c_/contents.html'
    pairs = list(versions)
    assert pairs == [('a', '../../sub/2.html'), ('b', '2.html'), ('c', '../../c_/contents.html')]

    versions.context['pagename'] = 'sub/sub/3'
    assert versions.vhasdoc('a') is True
    assert versions.vpathto('a') == '../../../sub/sub/3.html'
    assert versions.vhasdoc('b') is True
    assert versions.vpathto('b') == '3.html'
    assert versions.vhasdoc('c') is False
    assert versions.vpathto('c') == '../../../c_/contents.html'
    pairs = list(versions)
    assert pairs == [('a', '../../../sub/sub/3.html'), ('b', '3.html'), ('c', '../../../c_/contents.html')]

    versions.context['pagename'] = 'sub/sub/sub/4'
    assert versions.vhasdoc('a') is True
    assert versions.vpathto('a') == '../../../../sub/sub/sub/4.html'
    assert versions.vhasdoc('b') is True
    assert versions.vpathto('b') == '4.html'
    assert versions.vhasdoc('c') is False
    assert versions.vpathto('c') == '../../../../c_/contents.html'
    pairs = list(versions)
    assert pairs == [('a', '../../../../sub/sub/sub/4.html'), ('b', '4.html'), ('c', '../../../../c_/contents.html')]
...
def test_c():
    ...
    pairs = list(versions)
    assert pairs == [('a', '../contents.html'), ('b', '../b/contents.html'), ('c', 'contents.html')]
    ...
    pairs = list(versions)
    assert pairs == [('a', '../contents.html'), ('b', '../b/contents.html'), ('c', 'A.html')]
    ...
    pairs = list(versions)
    assert pairs == [('a', '../../contents.html'), ('b', '../../b/contents.html'), ('c', 'B.html')]
    ...
    pairs = list(versions)
    assert pairs == [('a', '../../../contents.html'), ('b', '../../../b/contents.html'), ('c', 'C.html')]
    ...
    pairs = list(versions)
    assert pairs == [('a', '../../../../contents.html'), ('b', '../../../../b/contents.html'), ('c', 'D.html')]
